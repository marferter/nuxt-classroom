...
<template>
    ...
    <div class="space-y-0.5" v-for="(opt,index) in options">
        ...
        <div  
            :class="{'bg-elevated/50': !submited, 'bg-red-50': submited && !userAnswersStatus[index],'bg-green-50': submited && userAnswersStatus[index]}"
            ...
            <CorrectAnswerIcon v-if="submited && userAnswersStatus[index]"/>
            <WrongAnswerIcon v-if="submited && !userAnswersStatus[index]"/>
        </div>
