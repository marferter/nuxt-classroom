...
}); //initialise une variable calculée, autrement dit qui se met à jour sitôt que les valeurs réactives dont elle dépend changent.
...
const toggleSubmited = () => {
    ...
    explain.value = false
    }// inverse la valeur de submitted ; fonctionnalité du bouton correspondant
